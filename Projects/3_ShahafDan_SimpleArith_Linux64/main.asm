...
;CS21. 09.21.2019
;Linux 64
;Simple Arithmetic Project Chapter 3
...
SECTION .data
;I just copied the copy from the 32 projct I just did
...
_start:
	...
	push rax ;could not call the variable value for some reason, so I just called to register to print whatever it stores
